...
{
    NSAssert(self.request!=nil, @"request memeber must be initialized");
    
    NSMutableString* methodString = [[NSMutableString alloc] init];
    switch (methodType)
    {
        case HTTPMethod_GET:
        {
            [methodString setString:@"GET"];
        }
        break;
        case HTTPMethod_POST:
        {
            [methodString setString:@"POST"];
        }
        break;
        case HTTPMethod_HEAD:
        {
            [methodString setString:@"HEAD"];
        }
        break;
        case HTTPMethod_TRACE:
        {
            [methodString setString:@"TRACE"];
        }
        break;
        case HTTPMethod_PUT:
        {
            [methodString setString:@"PUT"];
        }
        break;
        case HTTPMethod_DELETE:
        {
            [methodString setString:@"DELETE"];
        }
        break;
        case HTTPMethod_OPTION:
        {
            [methodString setString:@"OPTION"];
        }
        break;
        case HTTPMethod_CONNECT:
        {
            [methodString setString:@"CONNECT"];
        }
        break;
        default:
        {
            NSAssert(NO, @"Wrong HTTPMethodType");
        }
        break;
    }
    [self.request setHTTPMethod:methodString];
}

- (void)setValue:(NSString*)value forHTTPHeaderField:(NSString*)fieldName
{
    NSAssert(self.request!=nil, @"request memeber must be initialized");
    [self.request setValue:value forHTTPHeaderField:fieldName];
}
