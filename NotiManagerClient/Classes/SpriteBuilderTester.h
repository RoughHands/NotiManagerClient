...
#ifndef __NotiManagerClient__SpriteBuilderTester__
#define __NotiManagerClient__SpriteBuilderTester__
...
#endif /* defined(__NotiManagerClient__SpriteBuilderTester__) */
